...
import { NotFoundError, requireAuth, validateRequest, OrderStatus, BadRequestError } from '@tuebora/gittix-common';
...
router.post('/api/orders', requireAuth, [
    ...
    if (isReserved) {
        throw new BadRequestError('Ticket is already researved');
    }
