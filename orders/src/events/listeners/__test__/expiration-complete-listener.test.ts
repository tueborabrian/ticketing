...
import { OrderStatus, ExpirationCompleteEvent } from '@tuebora/gittix-common';
...
it('emit an OrderCancelled event', async () => {
    ...
    const eventData = JSON.parse((stanWrapper.client.publish as jest.Mock).mock.calls[0][1]);
